...
//
//  Created by Rishita Panchal on 07/05/22.
//
...
extension UIViewController {
    ...
    func configureBarButton() {
        ...
        let imageView = UIImageView(image: UIImage.init(resource: R.image.vectorback))
        imageView.frame = CGRect(x: 20, y: 30, width: 7, height: 14)
